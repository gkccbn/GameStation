...
namespace WindowsFormsApp2
{
    public partial class highscore : Form
    {
        ...
        private void verilerigoruntule() //tüm yüksek skorları high score kısmında görüntülüyoruz
        {
            baglanti.Open();
        ...
        private void button3_Click(object sender, EventArgs e)  //maile skorları gönderiyoruz
        {
            OleDbConnection baglanti = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=|DataDirectory|\\asd.mdb");
            baglanti.Open();
            OleDbCommand giris = new OleDbCommand("select *from aaaaa where kullaniciadi='"+Form1.kulad+"'", baglanti); //kisinin adına göre skorları okuyor
            OleDbDataReader oku = giris.ExecuteReader();
            if (oku.Read() && sayac == 0)  //sayac tutulma sebebi maili bir kere gönderebilmek
            {
