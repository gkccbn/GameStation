...
namespace WindowsFormsApp2
{
    public partial class UyeOl : Form
    {
        ...
        private void textBox2_Enter(object sender, EventArgs e) //şifre yıldızlı 
        {
        ...
        private void textBox3_Enter(object sender, EventArgs e) //şifre clicklemeden önce 'paswword again yazısı'
        {
        ...
        {
            if (textBox2.Text != textBox3.Text) //password kontolu
            {
            ...
            else
            {
                ...
                int kontrol = textBox4.Text.IndexOf('@'); //kişini mail varlığını kontrol etme
                if (oku.Read())
                {
