...
namespace WindowsFormsApp2
{
    public partial class Form5 : Form
    {
        ...
        {
            char[] kelimedizisi = secilenkelime.ToCharArray(); //kelime dizisine atılan random kelimede girilen harf var mı sorgusu yapılıyor
            bool dogru = false;
            ...
            switch (kalanhak) //kalan hakka göre adam asılıyor
            {
                case 0:
        ...
        private void levelatlama() //level atlama
        {
        ...
        private void oyunbitti() //adam asılınca oyun biter
        {
        ...
        {                                        //girilen harfleri aşağıya ekliyor görmemiz için
        ...
        private void button2_Click(object sender, EventArgs e) //harfin tekrar yazılmasını önlüyor
        {
            ...
            if (!soylendi) //eger harf kelimedeyse buldu true oluyor
            {
            ...
            int sart = label5.Text.IndexOf("_"); //eger bos kısım kalmadıysa level atlanabilir
            if (sart == -1)
            {
                levelatlama();
            }
        ...
        {
            Random rastgele = new Random();  //kelimelerin random kelmesini saglıyor kelime uzunlugunca - oluşuyor
