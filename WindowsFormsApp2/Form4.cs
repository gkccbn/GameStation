...
namespace WindowsFormsApp2
{
    public partial class Form4 : Form
    {
        ...
        private void GameTimer(object sender, EventArgs e) //meteorların hareketine göre meteoru geçtikçe skor artıyor
        {
            ...
            if (pictureBox2_spaceship.Bounds.IntersectsWith(pictureBox1_meteor1.Bounds) || //yukarı aşağı çarparsa oyun bitiyor
